...
description: >-
  ...
  iteration on failure), and final ADR documentation. Do NOT implement
  ...
  of done. Then it proceeds with planning, implementation, validation, and
  documentation.
  ...
  invokes a documentation agent to write the ADR.
