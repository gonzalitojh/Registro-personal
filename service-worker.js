...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260811',
  './css/ocio.css?v=20260811',
  './js/app.js?v=20260811',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  './js/config.js',
  ...
  './js/push.js',
  './resources/icon.png',
  './ocio/series.html?v=20260811',
  './ocio/peliculas.html?v=20260811',
  './ocio/libros.html?v=20260811',
];
