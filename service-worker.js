...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260927',
  './css/ocio.css?v=20260927',
  './js/app.js?v=20260927',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/shopping-list.js',
  './resources/icon.png',
  './ocio/series.html?v=20260927',
  './ocio/peliculas.html?v=20260927',
  './ocio/libros.html?v=20260927',
  './ocio/videojuegos.html?v=20260927',
];
