...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260833',
  './css/ocio.css?v=20260833',
  './js/app.js?v=20260833',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/push.js',
  './resources/icon.png',
  './ocio/series.html?v=20260833',
  './ocio/peliculas.html?v=20260833',
  './ocio/libros.html?v=20260833',
];
