...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260812',
  './css/ocio.css?v=20260812',
  './js/app.js?v=20260812',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  './js/config.js',
  ...
  './js/push.js',
  './resources/icon.png',
  './ocio/series.html?v=20260812',
  './ocio/peliculas.html?v=20260812',
  './ocio/libros.html?v=20260812',
];
