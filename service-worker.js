...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20261018',
  './css/ocio.css?v=20261018',
  './js/app.js?v=20261018',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/gym.js',
  './resources/icon.png',
  './ocio/series.html?v=20261018',
  './ocio/peliculas.html?v=20261018',
  './ocio/libros.html?v=20261018',
  './ocio/videojuegos.html?v=20261018',
];
