...
const STATIC_ASSETS = [
  ...
  './css/ocio.css?v=20261006',
  './js/app.js?v=20261006',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/gym.js',
  './resources/icon.png',
  './ocio/series.html?v=20261006',
  './ocio/peliculas.html?v=20261006',
  './ocio/libros.html?v=20261006',
  './ocio/videojuegos.html?v=20261006',
];
