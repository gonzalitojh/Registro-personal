...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260922',
  './css/ocio.css?v=20260922',
  './js/app.js?v=20260922',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/shopping-list.js',
  './resources/icon.png',
  './ocio/series.html?v=20260922',
  './ocio/peliculas.html?v=20260922',
  './ocio/libros.html?v=20260922',
  './ocio/videojuegos.html?v=20260922',
];
