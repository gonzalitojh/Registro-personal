...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260819',
  './css/ocio.css?v=20260819',
  './js/app.js?v=20260819',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/gym.js',
  './resources/icon.png',
  './ocio/series.html?v=20260819',
  './ocio/peliculas.html?v=20260819',
  './ocio/libros.html?v=20260819',
  './ocio/videojuegos.html?v=20260819',
];
