...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20260912',
  './css/ocio.css?v=20260912',
  './js/app.js?v=20260912',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/shopping-list.js',
  './resources/icon.png',
  './ocio/series.html?v=20260912',
  './ocio/peliculas.html?v=20260912',
  './ocio/libros.html?v=20260912',
  './ocio/videojuegos.html?v=20260912',
];
