...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20261016',
  './css/ocio.css?v=20261016',
  './js/app.js?v=20261016',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/gym.js',
  './resources/icon.png',
  './ocio/series.html?v=20261016',
  './ocio/peliculas.html?v=20261016',
  './ocio/libros.html?v=20261016',
  './ocio/videojuegos.html?v=20261016',
];
