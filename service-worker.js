...
const STATIC_ASSETS = [
  ...
  './index.html',
  './manifest.json',
  './css/styles.css?v=20261011',
  './css/ocio.css?v=20261011',
  './js/app.js?v=20261011',
  './js/router.js',
  './js/ui.js',
  './js/db.js',
  './js/firebase.js',
  ...
  './js/gym.js',
  './resources/icon.png',
  './ocio/series.html?v=20261011',
  './ocio/peliculas.html?v=20261011',
  './ocio/libros.html?v=20261011',
  './ocio/videojuegos.html?v=20261011',
];
