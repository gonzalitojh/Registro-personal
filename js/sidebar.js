...
import { navigate, getLastRecipesTab, getLastGymTab, getLastTodosTab } from "./router.js";
...
export const SECTIONS = [
  ...
  },
  {
    ...
    onClick: () => {
      // Abrir la sección Cosas que hacer sincronizando la URL: vuelve
      // a la pestaña que quedó activa la última vez (issue #283).
      navigate({ section: "todos", tab: getLastTodosTab() });
    },
  },
  {
    id: "settings",
